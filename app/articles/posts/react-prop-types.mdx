...
There are other ways to extract types, each with tradeoffs:
<table>
  <thead>
    <tr>
      <th>Approach</th>
  ...
  <tbody>
    <tr>
      ...
      <td><code>React.ComponentProps&lt;typeof Comp&gt;</code></td>
      <td>Clean, widely supported</td>
      <td>None really</td>
    </tr>
    <tr>
      <td>Parameters utility</td>
      <td><code>Parameters&lt;typeof Comp&gt;[0]</code></td>
      <td>Works with function components</td>
      <td>Verbose, less semantic</td>
    </tr>
    <tr>
      <td>JSX.IntrinsicElements</td>
      <td><code>JSX.IntrinsicElements['div']</code></td>
      <td>Good for HTML elements</td>
      <td>Only works with intrinsic elements</td>
    </tr>
  </tbody>
</table>
