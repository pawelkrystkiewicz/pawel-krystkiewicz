...
export const ExperienceEntry: FC<ExperienceEntryProps> = ({ experience: exp, showExpTime = true }) => {
  return (
      ...
      <div className="flex justify-between gap-2">
        ...
        <div className="flex flex-col text-right">
          <div className="flex gap-1 items-center">
            {showExpTime && <span className="text-text-secondary">{calculateTimeDiff(exp.start, exp.end)} @</span>}
            {exp.link ? (
              <Link
                href={exp.link}
                target="_blank"
