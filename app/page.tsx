    ...
    <>
      <section className='flex flex-col gap-4'>
        ...
        <Paragraph className='mb-4 text-lg'>
          I'm a web developer with {totalExperience} years of experience
          crafting well designed and impactful applications. Specializing in
          React, TypeScript with a good eye for modern UI/UX.
          {flags.cui && (
            <>
              {' '}
              Author of{' '}
